...
<p align="center">
  <a href="https://github.com/c4Luffy/exiled-bot-pickit-generator/releases/download/v4.42.4/ExileBot2PickitGenerator.exe"><img alt="Download v4.42.4 for Windows" src="https://img.shields.io/badge/Download-v4.42.4-c99a4a?style=for-the-badge&labelColor=171411&logo=windows11&logoColor=e8e0d3"></a>
...
Windows SmartScreen may ask for confirmation because this free community executable is not code-signed. You can verify the release with its [published SHA-256 checksum](https://github.com/c4Luffy/exiled-bot-pickit-generator/releases/download/v4.42.4/SHA256SUMS.txt).
...
[Read the complete v4.42.4 release notes](https://github.com/c4Luffy/exiled-bot-pickit-generator/releases/tag/v4.42.4) · [full changelog](CHANGELOG.md)
