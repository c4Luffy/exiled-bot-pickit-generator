...
<p align="center">
  <a href="https://github.com/c4Luffy/exiled-bot-pickit-generator/releases/download/v4.42.1/ExileBot2PickitGenerator.exe"><img alt="Download v4.42.1 for Windows" src="https://img.shields.io/badge/Download-v4.42.1-c99a4a?style=for-the-badge&labelColor=171411&logo=windows11&logoColor=e8e0d3"></a>
...
<p align="center">
  ...
  <a href="https://github.com/c4Luffy/exiled-bot-pickit-generator/releases/tag/v4.42.1">Release notes</a> ·
...
![Real Exiled Bot Pickit Generator v4.42.1 — Path of Exile 1 Generate screen](docs/shots/01-generate-poe1-v4420.png)

<p align="center"><sub>Real running-app capture · Path of Exile 1 · Generate · captured on v4.42.1</sub></p>

> [!IMPORTANT]
> **Using v4.20.0 or v4.21.0? Update manually once.** Close the old app, [download v4.42.1](https://github.com/c4Luffy/exiled-bot-pickit-generator/releases/download/v4.42.1/ExileBot2PickitGenerator.exe), and open it. Your settings, profiles, and Exiled Bot folder stay in place. Later in-app updates work normally.
...
Windows SmartScreen may ask for confirmation because this free community executable is not code-signed. You can verify the release with its [published SHA-256 checksum](https://github.com/c4Luffy/exiled-bot-pickit-generator/releases/download/v4.42.1/SHA256SUMS.txt).
...
[Read the complete v4.42.1 release notes](https://github.com/c4Luffy/exiled-bot-pickit-generator/releases/tag/v4.42.1) · [full changelog](CHANGELOG.md)
